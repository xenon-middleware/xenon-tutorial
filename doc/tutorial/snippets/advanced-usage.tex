...
\subsection{A minimal Eclipse installation}
...
\subsection{Automatic project setup with \texttt{gradlew}}
...
\subsection{Opening the Xenon examples in Eclipse}
...
\subsection{Running a Java program in Eclipse}
...
\subsection{Debugging a Java program in Eclipse}
...
\subsection{Setting the log level}
