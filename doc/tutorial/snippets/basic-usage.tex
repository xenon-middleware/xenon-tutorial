...
% TODO what is ssh
% TODO explain why ssh is so important (we use it for everything, all adaptors except local adaptor use it)
...
\end{lstlisting}
% TODO explain what happened id_rsa and id_rsa.pub

\begin{lstlisting}[style=basic,style=bash,escapeinside={(*@}{@*)}]
# copy identity
ssh-copy-id ${USER}@localhost
\end{lstlisting} % dummy $
% TODO explain what happened authorized_keys and known_hosts
...
\item{key-value pairs, e.g. the RSA fingerprint of the Lisa system \url{ssh-rsa} \url{b0:69:85:a5:21:d6:43:40:bc:6c:da:e3:a2:cc:b5:8b}.}  % FIXME wrong example; change to localhost
\end{itemize}
